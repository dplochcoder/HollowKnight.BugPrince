...
internal class ConnectionMenu
{
    ...
    private static List<IValueElement> GetElements<T>(
        ...
        where T : Attribute
    {
        ...
        {
            var name = e.Key;
            if (typeof(RandomizationSettings).GetField(name).GetCustomAttribute<T>() != null)
                ret.Add(e.Value);
        }
        return ret;
    }
    ...
    private ConnectionMenu(MenuPage connectionsPage)
    {
        ...
        var s = Settings;
        var enableTransitionChoices = (
            factory.ElementLookup[nameof(s.EnableTransitionChoices)] as MenuItem<bool>
        )!;
        enableCoinsAndGems = (
            factory.ElementLookup[nameof(s.EnableCoinsAndGems)] as MenuItem<bool>
        )!;
        ...
        transitionSettings = new(
            ...
            false,
            [.. GetElements<TransitionSettingAttribute>(factory)]
        );
        relicSettings = new(
            bugPrincePage,
            new(),
            ...
            false,
            [.. GetElements<RelicSettingAttribute>(factory)]
        );
        costSettings = new(
            bugPrincePage,
            new(),
            ...
            SpaceParameters.HSPACE_SMALL,
            false,
            [.. GetElements<CostSettingAttribute>(factory)]
        );
        ...
        mapShopSettings = new(
            ...
            SpaceParameters.HSPACE_MEDIUM,
            false,
            [.. GetElements<MapShopSettingAttribute>(factory)]
        );
        GridItemPanel locationSettings = new(
            bugPrincePage,
            new(),
            3,
            VSPACE,
            SpaceParameters.HSPACE_SMALL,
            false,
            [.. GetElements<LocationSettingAttribute>(factory).Where(m => m != mapShop)]
        );
    ...
    {
        entryButton.Text.color = BugPrinceMod.RS.IsEnabled
            ? Colors.TRUE_COLOR
